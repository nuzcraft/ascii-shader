...
@onready var final_texture: TextureRect = $Control/FinalViewportContainer/FinalSubViewport/FinalTexture
...
func init_shader():
	...
	compute_shader.add_uniform_array([shader_parameters_buffer, sobel_texture, lum_texture, output_texture])
